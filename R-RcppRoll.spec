...
Source0  : https://cran.r-project.org/src/contrib/RcppRoll_0.3.1.tar.gz
...
%setup -q -n RcppRoll
pushd ..
cp -a RcppRoll buildavx2
popd
pushd ..
cp -a RcppRoll buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720454666
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/RcppRoll/libs/RcppRoll.so
/V4/usr/lib64/R/library/RcppRoll/libs/RcppRoll.so
